...
public class MethodTester extends Picture
{
  public static void main (String[] args) throws IOException
  {
    ...
    int result2 = embedDigits2(13,1);
    System.out.println("The result of embdDigits2(13,1) is " + result2);
    if ( result2 == 13 ) {
      System.out.println( "This is correct!" );
    }
    else {
    ...
    result2 = embedDigitsN(64,2,5);
    System.out.println( "The result of embedDigitsN(64,2,5) is " + result2 );
    if ( result2 == 66 ) {
      System.out.println( "This is correct!" );
    }
    else {
    ...
    result2 = getLeastSignificant2(63);
    System.out.println( "The result of getLeastSignificant2(63) is " + result2 );
    if ( result2 == 3 ) {
      System.out.println( "This is correct!" );
    }
    else {
    ...
    result2 = getLeastSignificantN(28,4);
    System.out.println( "The result of getLeastSignificantN(28,4) is " + result2 );
    if ( result2 == 12 ) {
      System.out.println( "This is correct!" );
    }
    else {
